        ...
        options : [
          {
            ...
            legend: {
              ...
              orient:'vertical',
              padding: 0,
              data:['SQL Database','Storage','Virtual Machines','Power BI Embedded','Otros']
            },
            toolbox: {
              show : true,
            ...
            series : [
              {
                ...
                data:[{value: 35,  name:'SQL Database'}, {value: 16,  name:'Storage'}, {value: 27,  name:'Virtual Machines'}, {value: 29,  name:'Power BI Embedded'}, {value: 12,  name:'Otros'}]
              }
            ]
          },
          {
            series : [
              {
                name:'05-16',
                type:'pie',
                    data: [{ value: 42, name: 'SQL Database' }, { value: 51, name: 'Storage' }, { value: 39, name: 'Virtual Machines' }, { value: 25, name:'Power BI Embedded'}, {value: 9,  name:'Otros'}]
              }
            ]
          },
          {
            series : [
              {
                name:'04-16',
                type:'pie',
                    data: [{ value: 29, name: 'SQL Database' }, { value: 16, name: 'Storage' }, { value: 24, name: 'Virtual Machines' }, { value: 19, name:'Power BI Embedded'}, {value: 5,  name:'Otros'}]
              }
            ]
          },
