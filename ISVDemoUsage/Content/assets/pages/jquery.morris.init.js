...
!function($) {
    ...
    MorrisCharts.prototype.init = function() {
        ...
        var $stckedData  = [
            { y: 'Mayo', a: 45, b: 180, c: 100 },
            { y: 'Junio', a: 75,  b: 65, c: 80 },
            { y: 'Julio', a: 100, b: 90, c: 56 },
            { y: 'Agosto', a: 75,  b: 65, c: 89 },
            { y: 'Septiembre', a: 100, b: 90, c: 120 },
            { y: 'Octubre', a: 75,  b: 65, c: 110 },
            { y: 'Noviembre', a: 50,  b: 40, c: 85 },
            { y: 'Diciembre', a: 75,  b: 65, c: 52 },
            { y: 'Enero', a: 50,  b: 40, c: 77 },
            { y: 'Febrero', a: 75,  b: 65, c: 90 },
            { y: 'Marzo', a: 100, b: 90, c: 130 },
            { y: 'Abril', a: 80, b: 65, c: 95 }
        ];
