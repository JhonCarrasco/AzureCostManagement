...
namespace ISVDemoUsage.Controllers
{
    public class SubscriptionController : Controller
    {
        ...
        public ActionResult ResourcerAllBySubscription([Bind(Include = "Id, OrganizationId")] Subscription subscription, string servicePrincipalObjectId)
        {
            //if (ModelState.IsValid)
            //{
            //    AzureResourceManagerUtil.GrantRoleToServicePrincipalOnSubscription(servicePrincipalObjectId, subscription.Id, subscription.OrganizationId);
            ...
            return RedirectToAction("ResourcerAllBySubscription", "Home", new { subscriptionId = subscription.Id, organizationId = subscription.OrganizationId });
        }
