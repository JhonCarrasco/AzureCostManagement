...
namespace ISVDemoUsage
{
    public static class AzureResourceManagerUtil
    {
            ...
            string metricnamespace)
        {
            ...
            try
            {
                string accessToken = AuthenticationUser.GetAccessToken(organizationId);
            ...
            {
                Console.WriteLine("HttpWebResponse ERROR");
            }
            return responseString;
        }
        public static string GetMetricDefinitions(string organizationId, string resourceUri)
        {
            ...
            try
            {
                ...
                //string requestUrl = "GET https://management.azure.com/{resourceUri}/providers/microsoft.insights/metricDefinitions?api-version=2018-01-01";
                // Get subscriptions to which the user has some kind of access
                string requestUrl = string.Format("{0}{1}/providers/microsoft.insights/metricDefinitions?api-version=2018-01-01",
                ConfigurationManager.AppSettings["ida:AzureResourceManagerUrl"], resourceUri);
                ...
                resourcersResponse = readStream.ReadToEnd();
            }
            catch
            {
                Console.WriteLine("HttpWebResponse ERROR");
            }
            return resourcersResponse;
        }
        public static string GetResourceGroups(string subscriptionId, string organizationId)
        {
            string signedInUserUniqueName = ClaimsPrincipal.Current.FindFirst(ClaimTypes.Name).Value.Split('#')[ClaimsPrincipal.Current.FindFirst(ClaimTypes.Name).Value.Split('#').Length - 1];
            string resourcersResponse = "";
            ...
            try
            {
                ...
                // string requestUrl = "https://management.azure.com/subscriptions/96d674d0-8c48-4e41-a578-cce0b39c0ea9/resourcegroups?api-version=2019-10-01";
                // Get subscriptions to which the user has some kind of access
                string requestUrl = string.Format("{0}/subscriptions/{1}/resourcegroups?api-version=2019-10-01",
                ConfigurationManager.AppSettings["ida:AzureResourceManagerUrl"],
                subscriptionId);
        ...
        public static string GetResourcersByResourcerGroup(string subscriptionId, string organizationId, string resoucerGroup)
        {
            string signedInUserUniqueName = ClaimsPrincipal.Current.FindFirst(ClaimTypes.Name).Value.Split('#')[ClaimsPrincipal.Current.FindFirst(ClaimTypes.Name).Value.Split('#').Length - 1];
            string resourcersResponse = "";
            ...
            try
            {
                ...
                // string requestUrl = "https://management.azure.com/subscriptions/96d674d0-8c48-4e41-a578-cce0b39c0ea9/resourceGroups/Default-Ignite-Test/resources?api-version=2019-10-01";
                // Get subscriptions to which the user has some kind of access
                string requestUrl = string.Format("{0}/subscriptions/{1}/resourceGroups/{2}/resources?api-version=2019-10-01",
                ConfigurationManager.AppSettings["ida:AzureResourceManagerUrl"],
                subscriptionId, resoucerGroup);
        ...
        public static string GetMonitorOperationsList(string organizationId)
        {
            string signedInUserUniqueName = ClaimsPrincipal.Current.FindFirst(ClaimTypes.Name).Value.Split('#')[ClaimsPrincipal.Current.FindFirst(ClaimTypes.Name).Value.Split('#').Length - 1];
            ...
            try
            {
                ...
                // Get subscriptions to which the user has some kind of access
                string requestUrl = string.Format("{0}/providers/microsoft.insights/operations?api-version=2015-04-01",
                    ConfigurationManager.AppSettings["ida:AzureResourceManagerUrl"]);
                ...
                // Pipes the stream to a higher level stream reader with the required encoding format. 
                StreamReader readStream = new StreamReader(receiveStream, Encoding.UTF8);
                operationResponse = readStream.ReadToEnd();
            }
            catch
            {
        ...
        public static string GetResourcerAllBySubscription(string subscriptionId, string organizationId)
        {
            //List<Resourcer> resourcers = null;

            string signedInUserUniqueName = ClaimsPrincipal.Current.FindFirst(ClaimTypes.Name).Value.Split('#')[ClaimsPrincipal.Current.FindFirst(ClaimTypes.Name).Value.Split('#').Length - 1];
            string resourcerResponse = "";
            ...
            try
            {
                ...
                //resourcers = new List<Resourcer>();

                // Get subscriptions to which the user has some kind of access
                string requestUrl = string.Format("{0}/subscriptions/{1}/resources?api-version=2019-10-01",
                ...
                //    var resourcersResult = (Json.Decode(responseContent)).value;

                //    foreach (var resource in resourcersResult)
                //        resourcers.Add(new Resourcer()
                //        {
                //            Id = resource.id,
                //            Name = resource.name,
                ...
                // Pipes the stream to a higher level stream reader with the required encoding format. 
                StreamReader readStream = new StreamReader(receiveStream, Encoding.UTF8);
                resourcerResponse = readStream.ReadToEnd();
            }
            catch
            {

            }
            return resourcerResponse;
        }
        ...
        public static string GetUsage(string subscriptionId, string organizationId)
        {
            ...
            try
            {
                ...
                string requesturl = String.Format("https://management.azure.com/{resourceUri}/providers/microsoft.insights/metricDefinitions?api-version=2018-01-01", subscriptionId);
        ...
        public static string GetSubscriptionQueryGrouping(string subscriptionId, string organizationId)
        {
            string signedInUserUniqueName = ClaimsPrincipal.Current.FindFirst(ClaimTypes.Name).Value.Split('#')[ClaimsPrincipal.Current.FindFirst(ClaimTypes.Name).Value.Split('#').Length - 1];
            string UsageResponse = "";
            try
            {
                ...
                string requesturl = String.Format("https://management.azure.com/subscriptions/{0}/providers/Microsoft.CostManagement/query?api-version=2019-11-01", subscriptionId);
        ...
        public static string GetResourceGroupQueryGrouping(string subscriptionId, string organizationId, string resoucerGroup)
        {            
            string responseString = "";
            try
            {
                ...
                //SubscriptionQueryGrouping-Legacy
                string requestUrl = String.Format("https://management.azure.com/subscriptions/{0}/resourceGroups/{1}/providers/Microsoft.CostManagement/query?api-version=2019-11-01", subscriptionId, resoucerGroup);
                ...
                responseString = HttpCallAPI.PostHttpCall(requestUrl, accessToken, requestBody);
